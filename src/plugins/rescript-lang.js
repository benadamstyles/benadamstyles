/**
 * Copy-pasted from
 * https://github.com/reason-association/rescript-lang.org/blob/master/plugins/res-syntax-highlightjs.js
 */
...
module.exports = function (hljs) {
  ...
  const CONSTRUCTOR_MODE = {
    ...
    begin:
      '\\b([A-Z][0-9a-zA-Z_]*)|(`[a-zA-Z][0-9a-zA-Z_]*)|(#[a-zA-Z][0-9a-zA-Z_]*)\\b',
  }
